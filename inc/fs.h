...
struct DirectoryEntry {         //sizeof = 61
   ...
   short max_sectors,           //kiek daugiausiai sektoriu gali sudaryti faila, reiksme 0 reiskia neribota kieki
     start_sector, header_size, record_size;    //reikalingas jei failas sudarytas is fiksuoto dydzio irasu, kurie negali buti perskirti, kas gali atsitikti ties sektoriu riba; isuo atveju cia record size turi dalinti 256 be liekanos, pvz. 1, 2, 4 ir t.t.
   char file_name[MAX_FILE_NAME_SIZE], header[MAX_HEADER_SIZE];
};
